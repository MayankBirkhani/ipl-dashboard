package com.springproject.ipldashboard.data;
...
public class BatchConfig {
    ...
    // we are doing a write operation here in Match Instance. we are inserting data
    // into Match table.
    // below are the columns names in the match tables, these are properties name in
    // Match.java. here camelcase is removed by defualt it will use _
    @Bean
